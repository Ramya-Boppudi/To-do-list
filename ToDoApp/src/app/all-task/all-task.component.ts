...
export class AllTaskComponent implements OnInit {
  ...
  constructor(private ser:UserServiceService, private http:HttpClient,private dialog:MatDialog,private route:RouteService,private toastr: ToastrService){
...
//card filteration 
  ...
  setStatus(id:string){ 
    if(confirm("Are you Sure you want to archive?Is Task completed")){
      console.log(id);
      this.ser.getNote(id).subscribe(id => {
        this.obj = id;
